...
class RealQuantumService {
     ...
     */
    static async generateQuantumRandom(length) {
        ...
        try {
            ...
            const response = await axios_1.default.get(`https://qrng.anu.edu.au/API/jsonI.php?length=${length}&type=uint8`, { timeout: 5000 });
     ...
     */
    static async generateQuantumPassword(length, includeSymbols) {
