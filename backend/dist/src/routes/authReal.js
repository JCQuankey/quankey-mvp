 ...
 */
exports.authRealRouter.post('/register/begin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield webauthnServiceReal_1.WebAuthnService.generateRegistrationOptions(username, username, displayName);
 ...
 */
exports.authRealRouter.post('/register/finish', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const verification = yield webauthnServiceReal_1.WebAuthnService.verifyRegistration(username, response);
 ...
 */
exports.authRealRouter.post('/login/begin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { username } = req.body;
        console.log(`🔍 [WEBAUTHN-REAL] Starting REAL biometric authentication for: ${username || 'any user'}`);
        const result = yield webauthnServiceReal_1.WebAuthnService.generateAuthenticationOptions(username);
        res.json(Object.assign({ success: true }, result));
    }
    catch (error) {
 ...
 */
exports.authRealRouter.post('/login/finish', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const verification = yield webauthnServiceReal_1.WebAuthnService.verifyAuthentication(response, challengeId);
        if (verification.verified) {
...
exports.authRealRouter.get('/webauthn/info', (req, res) => {
    try {
        const securityInfo = webauthnServiceReal_1.WebAuthnService.getSecurityInfo();
        res.json(Object.assign({ success: true, implementation: 'Real WebAuthn (Production Ready)', recoveryStatus: 'Security Recovery Complete' }, securityInfo));
    }
    catch (error) {
 ...
 */
exports.authRealRouter.post('/extension-login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { response, challengeId } = req.body;
