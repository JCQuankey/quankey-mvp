 ...
 */
router.post('/create', auth_middleware_1.authenticatePasskey, async (req, res) => {
    try {
 ...
 */
router.post('/consume', inputValidation_middleware_1.inputValidation.validatePairingConsume(), async (req, res) => {
    try {
 ...
 */
router.delete('/:token', auth_middleware_1.authenticatePasskey, async (req, res) => {
    try {
