 ...
 */
router.post('/setup', authenticatePasskey, inputValidation.validateGuardianSetup(), async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/recovery/initiate', inputValidation.validateRecoveryInit(), async (req: Request, res: Response) => {
  try {
    ...
    const recoveryRequestId = randomBytes(16).toString('hex');
 ...
 */
router.post('/recovery/complete', inputValidation.validateRecoveryComplete(), async (req: Request, res: Response) => {
  try {
 ...
 */
router.delete('/revoke/:guardianId', authenticatePasskey, async (req: Request, res: Response) => {
  try {
