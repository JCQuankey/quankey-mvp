...
exports.replaceBigIntInObject = replaceBigIntInObject;
exports.serializeWebAuthnResponse = serializeWebAuthnResponse;
exports.createSafeUserResponse = createSafeUserResponse;
function serializeBigInt(obj) {
    return JSON.parse(JSON.stringify(obj, (key, value) => typeof value === 'bigint' ? value.toString() : value));
}
function replaceBigIntInObject(obj) {
 ...
 */
function serializeWebAuthnResponse(data) {
