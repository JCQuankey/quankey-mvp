    ...
    try {
        ...
        try {
            ...
            if (token.startsWith('{')) {
                ...
                userId = parsed.userId || parsed.id || ((_a = parsed.user) === null || _a === void 0 ? void 0 : _a.id);
                username = parsed.username || parsed.displayName || ((_b = parsed.user) === null || _b === void 0 ? void 0 : _b.username);
            }
