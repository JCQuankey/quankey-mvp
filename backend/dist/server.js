...
app.use('/api/vault', (0, intelligentThreatDetection_1.createIntelligentRateLimiter)('vaultAccess'), auth_2.authMiddleware, // 🔴 FIX: Add auth middleware to vault routes
(0, auditLogging_1.auditMiddleware)(auditLogging_1.AuditEventType.VAULT_ACCESSED, 'Quantum Vault Access', auditLogging_1.RiskLevel.HIGH), vault_1.default);
